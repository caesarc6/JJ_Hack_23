    ...
    return(
        <div className='data-box2' style={{ textAlign: 'center' }}>
            ...
            <p contentEditable style={{ fontFamily: 'Arial', margin: '100px auto' }}>
                ...
                <h3>RECYCLE ALWAYS! Do you have endless amounts of empty water bottles in your room? Recycle those bottles 
                into something useful! Maybe make a flower pot, or use it store excessive kitchen necessities,
                don't throw out anything you can use again.</h3>
            </p>
        </div>
    )
}
